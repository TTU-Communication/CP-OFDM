...
tClipBlank = @(T) (T + 0.75);    % Clipping-Blanking
deepMu = 2.0;                   % Deep-Clipping
tClipReplace = @(T) (T + 0.5);  % Replacement-Clipping-Blanking Clipping
tClReBlank = @(T) (T + 1.0);    % Replacement-Clipping-Blanking Blanking
